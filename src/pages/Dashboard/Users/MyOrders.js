...
const MyOrders = () => {
  ...
  const {
    ...
    fetch(`https://techfly-server-side.vercel.app/purchase?email=${email}`, {
      method: "GET",
      headers: {
            ...
            {orders?.data?.map((order, index) => (
              <tr key={order._id}>
                ...
                <td>
                  {!order.paid && (
                    <label
                      htmlFor="deleteMyOrder"
                      className="btn btn-error btn-outline flex justify-center items-center "
